...
function displayPortfolioCard(PortfolioCard, i) {
  ...
  if (PortfolioCard.img == '') {
    ...
    image = <Image src={PortfolioCard.img} width="100%" height="60px" layout="responsive" objectFit="cover" />
  }
...
const Portfolio = () => (
  <Section id="portfolio">
    <div className="row no-gutters">
      ...
      <div className="row no-gutters">{PortfolioCardInfo.map((PortfolioCard, i) => displayPortfolioCard(PortfolioCard, i))}</div>
    </div>
  </Section>
)
