const FillPatternLine = ({ width = 100, thickness = 4, color = 'var(--color-placeholder)', id = 'patternLine' }) => {
  return (
...
const FillPatternCircle = ({ thickness = 4, color = 'var(--color-placeholder)', id = 'patternCircle' }) => {
  return (
...
const BarFaceTop = ({ xShift, yShift, thickness = 4, color = 'var(--color-placeholder)', fill = { background: 'none', pattern: 'url(#patternLine)' } }) => {
  return (
    <g>
      <path
...
const BarFaceLeft = ({ xShift, yShift, height, thickness = 4, color = 'var(--color-placeholder)', fill = { background: 'none', pattern: 'none' } }) => {
  return (
    <g>
      <path d={`M 0 ${yShift} v ${height} l ${xShift} ${yShift} v -${height} z`} fill={fill.background} stroke={color} strokeWidth={thickness} strokeLinejoin="round" />
      <path d={`M 0 ${yShift} v ${height} l ${xShift} ${yShift} v -${height} z`} fill={fill.pattern} stroke={color} strokeWidth={thickness} strokeLinejoin="round" />
    </g>
  )
}

const BarFaceRight = ({ xShift, yShift, height, thickness, color = 'var(--color-placeholder)', fill = { background: 'none', pattern: 'url(#patternCircle)' } }) => {
  return (
    <g>
      <path d={`M ${xShift * 2} ${yShift} v ${height} l -${xShift} ${yShift} v -${height} z`} fill={fill.background} stroke={color} strokeWidth={thickness} strokeLinejoin="round" />
      <path d={`M ${xShift * 2} ${yShift} v ${height} l -${xShift} ${yShift} v -${height} z`} fill={fill.pattern} stroke={color} strokeWidth={thickness} strokeLinejoin="round" />
    </g>
  )
}
