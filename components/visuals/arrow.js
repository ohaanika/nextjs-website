  ...
  return (
    <div style={{ width: width, height: height }}>
      ...
      <svg viewBox="0 0 100 100">
        <defs>
          <marker id="arrow" viewBox="0 0 10 13" refX={arrowWidth / 2} refY={arrowWidth / 2} markerWidth="6" markerHeight="6" orient="auto">
            <path
              d={`M ${thickness} ${thickness} 
        ...
        <path d="M 10 10 h 50" fill="none" stroke={color} strokeWidth={thickness} markerEnd="url(#arrow)" />
