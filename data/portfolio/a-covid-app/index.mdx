...
The [<u>Interventions Dashboard</u>](https://intervention-model.herokuapp.com/) is an MVP we put together for Google in 2020. Under tight time constraints (3-4 weeks), we managed to complete our objective: successfully reproduce an R-Shiny dashboard entirely using the tools of Plotly and Dash!

This webapp is coded in Python and is leveraging both the open-source [Dash](https://dash.plotly.com/) library and the [Dash Design Kit](https://plotly.com/dash/design-kit/), Plotly’s Enterprise solution.
